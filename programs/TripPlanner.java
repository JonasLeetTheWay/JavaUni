...
public class TripPlanner {
    ...
    public final static String[] months = {"Jan", "Feb", "Mar", "Apr", "May", "June", "Jul","Aug", "Sep", "Oct", "Nov", "Dec"};
    ...
    public static String month_travel;
    ...
    public static void convertWeekday(){
...
//    }
    ...
    private static String queryString(String args) {
        System.out.println(args);
        return input.next();
    }

    private static int queryInt(String args) {
        System.out.println(args);
        return input.nextInt();
    }

    private static double queryDouble(String args) {
        System.out.println(args);
        return input.nextDouble();
    }

    private static boolean queryBoolean(String args) {
        System.out.println(args);
